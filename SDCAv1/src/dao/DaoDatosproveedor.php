...
class DaoDatosproveedor extends DaoBase{
	...
	const SELECT_UNO 	 = "SELECT * FROM  datosproveedor  WHERE id_proveedor = :id_proveedor ";
	...
	const DELETE 	 = "DELETE FROM datosproveedor WHERE id_proveedor = :id_proveedor ";
	
	
	// Class Constructor
	public function __construct () {
		parent::__construct ("App\modelos\Datosproveedor");
	}
